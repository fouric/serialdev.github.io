...
(setq cols '("Title(URL)" "Author" "language" "Book" "Blog" "Paper"
 "Theory" "Implementation" "Free"))


(setq low-level-list '(

("[What Every Computer Scientist Should Know About Floating-Point Arithmetic](https://docs.oracle.com/cd/E19957-01/806-3568/ncg_goldberg.html )" "David Goldberg" "--" "✖✖✔✖✔" "bl✖✖✔" "th✖✔" "im✖✖✔" "f✖✔" "ee✖✔")
